1. Hiểu rõ về Node.js và JavaScript cơ bản
...
- [v] SQL Database (MySQL/PostgreSQL): Học cách làm việc với cơ sở dữ liệu quan hệ, sử dụng Sequelize hoặc TypeORM để thao tác dữ liệu.
